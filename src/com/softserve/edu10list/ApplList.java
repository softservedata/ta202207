...
public class ApplList {
	public static void main(String[] args) {
		/*
		List my = new ArrayList(); // raw type; List<Object>
		...
		*/
		/*-
		String[] arrStr = { "222", "1", "1111", "10" }; // new String [] {...}
		...
		*/
		...
		List<String> lstStr = new ArrayList<>(Arrays.asList(arrStr)); // Ok, Array to List
